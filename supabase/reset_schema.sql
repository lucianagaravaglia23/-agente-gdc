-- Este script reemplaza las tablas existentes por el esquema correcto.
-- Seguro de correr: las 4 tablas ya creadas están vacías (0 filas), no se pierde nada.
-- Correr completo en el SQL Editor de Supabase.

drop table if exists question_escalations cascade;
drop table if exists audit_log cascade;
drop table if exists tareas cascade;
drop table if exists respuestas_diagnostico cascade;
